...
impl<W: Pointer> Clone for ByPointer<W> {
    fn clone(&self) -> Self {
        Self::new(self.inner.clone())
    }
}

impl<W: Pointer> core::fmt::Debug for ByPointer<W> {
    fn fmt(&self, fmt: &mut core::fmt::Formatter) -> core::fmt::Result {
        fmt.debug_tuple("WeakKey").field(&self.inner.key()).finish()
    }
}

impl<W: Pointer> PartialEq for ByPointer<W> {
...
impl<W: Pointer> Eq for ByPointer<W> {}

impl<W: Pointer> core::hash::Hash for ByPointer<W> {
    fn hash<H: core::hash::Hasher>(&self, state: &mut H) {
        self.inner.key().hash(state)
    }
}

impl<W: Pointer> PartialOrd for ByPointer<W> {
    fn partial_cmp(&self, other: &Self) -> Option<core::cmp::Ordering> {
        Some(self.cmp(other))
    }
}

impl<W: Pointer> Ord for ByPointer<W> {
    fn cmp(&self, other: &Self) -> core::cmp::Ordering {
        self.inner.key().cmp(&other.inner.key())
    }
}

impl<W: Pointer> From<W> for ByPointer<W> {
